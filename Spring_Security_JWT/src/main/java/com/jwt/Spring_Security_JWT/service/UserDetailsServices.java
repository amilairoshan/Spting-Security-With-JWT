...
public class UserDetailsServices implements UserDetails {
	...
	public UserDetailsServices(Long id, String username, String password,
	...
	public static UserDetailsServices build(User user) {
	...
	public boolean equals(Object o) {
		...
		if (o == null || getClass() != o.getClass())
			return false;
		UserDetailsServices user = (UserDetailsServices) o;
